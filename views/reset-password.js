...
export default class ResetPasswordTemplate {
    socialUrls = {
        facebook: "",
        instagram: ""
    }
    ...
    constructor(token, recipient, ipAddress) {
        this.token = token;
    ...
    render() {
      ...
      <div style="font-family: 'Kalameh', sans-serif; mso-line-height-rule: exactly; display: none;">
          .درخواستی برای بازنشانی رمز عبور حساب گمرگ شما دریافت شد
      </div>
                      ...
                      <table class="sm-w-full" style="width: 600px;" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                              <td class="sm-py-32 sm-px-24"
                                  ...
                                  <a href="" style="font-family: 'Kalameh', sans-serif; mso-line-height-rule: exactly;">
                                      ...
                                      <tr>
                                          <td class="sm-px-24"
                                              ...
                                              <p style="font-family: 'Kalameh', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                  .درخواستی برای بازنشانی رمز عبور حساب
                                              </p>
                                              <p style="font-family: 'Kalameh', sans-serif; mso-line-height-rule: exactly; margin-bottom: 0; font-size: 20px; font-weight: 600;">
                                                  درخواست بازنشانی رمز عبور</p>
      ...
      <br/>
                                              ...
                                              <p style="font-family: 'Kalameh', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                  ازین کد برای تائید بازنشانی رمز عبور تان استفاده کنید.</p>
                                              <p
